...
const WomenPage = () => {
  ...
  const [products, setProducts] = useState([
    {
      ...
      sizes: ['S', 'M', 'L'],
      image: './public/store-pics/womenpage/women1.jpg', // Placeholder image URL
    },
    {
      id: 2,
      name: 'Product 2',
    ...
    },
    {
      ...
      sizes: ['S', 'M', 'L'],
      image: './public/store-pics/womenpage/women4.jpg', // Placeholder image URL
    },
    {
      id: 5,
      name: 'Product 5',
    ...
    },
    {
      ...
      sizes: ['S', 'M', 'L'],
      image: './public/store-pics/womenpage/women6.jpg', // Placeholder image URL
    },
  ]);
  ...
  return (
    <div className="container mx-auto mt-10">
      <h2 className="text-2xl font-bold mb-4">Women Products</h2>
